...
class Phase1Reconnaissance:
    ...
    def analyze_file_for_credentials(self, file_path, filename):
        ...
        try:
            ...
            output_filename = f"extracted_{filename.replace('/', '_').replace('\\', '_')}"
            ...
            if interesting_lines:
                ...
                cred_filename = f"potential_creds_{filename.replace('/', '_').replace('\\', '_')}.txt"
...
# Example usage:
# python3 phase1_fixed.py 13.203.132.120 -d cybersuraksha.local
